...
@NamedQueries({
    ...
    , @NamedQuery(name = "LogAudit.findByLikeLogAudit", query = "SELECT l FROM LogAudit l WHERE l.logAudit LIKE :logAudit")
    ...
    , @NamedQuery(name = "LogAudit.findByLikeDate", query = "SELECT l FROM LogAudit l WHERE l.date LIKE :date")
    ...
    , @NamedQuery(name = "LogAudit.updatePrimaryKey", query = "UPDATE LogAudit l SET l.logAudit = :logAuditNew WHERE l.logAudit = :logAuditOld")
})
public class LogAudit implements Serializable {
    ...
    public String toString() {
        return "co.edu.sena.model.jpa.entities.LogAudit[ logAudit=" + logAudit + " ]";
    }
