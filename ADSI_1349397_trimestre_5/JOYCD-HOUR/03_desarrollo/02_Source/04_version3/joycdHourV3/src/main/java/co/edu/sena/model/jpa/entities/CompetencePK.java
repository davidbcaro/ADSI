...
public class CompetencePK implements Serializable {
    ...
    public CompetencePK(String competenceCode, String programCode, String version) {
    ...
    public String toString() {
        return "co.edu.sena.model.jpa.entities.CompetencePK[ competenceCode=" + competenceCode + ", programCode=" + programCode + ", version=" + version + " ]";
    }
