...
public class CustomerPK implements Serializable {
    ...
    @Basic(optional = false)
    @Column(name = "identification_card_number", nullable = false, length = 15)
    private String identificationCardNumber;

    public CustomerPK() {
    }

    public CustomerPK(String documentType, String identificationCardNumber) {
    ...
    public String toString() {
        return "co.edu.sena.model.jpa.entities.CustomerPK[ documentType=" + documentType + ", identificationCardNumber=" + identificationCardNumber + " ]";
    }
