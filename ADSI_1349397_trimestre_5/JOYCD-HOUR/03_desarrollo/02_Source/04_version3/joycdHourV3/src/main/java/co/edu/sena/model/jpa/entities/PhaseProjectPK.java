...
public class PhaseProjectPK implements Serializable {
    ...
    public PhaseProjectPK(String namePhase, String projectCode) {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof PhaseProjectPK)) {
            return false;
        }
        PhaseProjectPK other = (PhaseProjectPK) object;
    ...
    public String toString() {
        return "co.edu.sena.model.jpa.entities.PhaseProjectPK[ namePhase=" + namePhase + ", projectCode=" + projectCode + " ]";
    }
