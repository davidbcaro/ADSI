...
calls to this DAO, otherwise a new Connection will be allocated for each operation.
	 ...
	 */
	protected final String SQL_SELECT = "SELECT name_headquarters, direction, status FROM " + getTableName() + "";
	 ...
	 */
	protected final String SQL_INSERT = "INSERT INTO " + getTableName() + " ( name_headquarters, direction, status ) VALUES ( ?, ?, ? )";

	/** 
	 * SQL UPDATE statement for this table
	 */
	protected final String SQL_UPDATE = "UPDATE " + getTableName() + " SET name_headquarters = ?, direction = ?, status = ? WHERE name_headquarters = ?";
	 ...
	 */
	protected static final int COLUMN_DIRECTION = 2;
	...
	{
		return findByDynamicSelect( SQL_SELECT + " WHERE direction = ? ORDER BY direction", new Object[] { direction } );
	}
	...
	protected void populateDto(Headquarters dto, ResultSet rs) throws SQLException
	{
		...
		dto.setDirection( rs.getString( COLUMN_DIRECTION ) );
