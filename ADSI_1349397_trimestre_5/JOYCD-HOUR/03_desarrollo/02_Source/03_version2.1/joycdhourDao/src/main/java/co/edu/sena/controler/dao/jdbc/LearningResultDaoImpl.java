...
calls to this DAO, otherwise a new Connection will be allocated for each operation.
	 ...
	 */
	protected final String SQL_SELECT = "SELECT learning_result_code, description, Program_code, competence_code, version FROM " + getTableName() + "";
	 ...
	 */
	protected final String SQL_INSERT = "INSERT INTO " + getTableName() + " ( learning_result_code, description, Program_code, competence_code, version ) VALUES ( ?, ?, ?, ?, ? )";

	/** 
	 * SQL UPDATE statement for this table
	 */
	protected final String SQL_UPDATE = "UPDATE " + getTableName() + " SET learning_result_code = ?, description = ?, Program_code = ?, competence_code = ?, version = ? WHERE learning_result_code = ? AND Program_code = ? AND competence_code = ? AND version = ?";

	/** 
	 * SQL DELETE statement for this table
	 */
	protected final String SQL_DELETE = "DELETE FROM " + getTableName() + " WHERE learning_result_code = ? AND Program_code = ? AND competence_code = ? AND version = ?";
	 ...
	 */
	protected static final int COLUMN_COMPETENCE_CODE = 4;
	...
	public void update(LearningResultPk pk, LearningResult dto) throws LearningResultDaoException
	{
		...
		try {
			...
			stmt.setString( index++, dto.getCompetenceCode() );
			stmt.setString( index++, dto.getVersion() );
			stmt.setString( 6, pk.getLearningResultCode() );
			stmt.setString( 7, pk.getProgramCode() );
			stmt.setString( 8, pk.getCompetenceCode() );
	...
	{
		return findByPrimaryKey( pk.getLearningResultCode(), pk.getProgramCode(), pk.getCompetenceCode(), pk.getVersion() );
	}
	...
	{
		LearningResult ret[] = findByDynamicSelect( SQL_SELECT + " WHERE learning_result_code = ? AND Program_code = ? AND competence_code = ? AND version = ?", new Object[] { learningResultCode, programCode, competenceCode, version } );
	...
	{
		return findByDynamicSelect( SQL_SELECT + " ORDER BY learning_result_code, Program_code, competence_code, version", null );
	}
	...
	{
		return findByDynamicSelect( SQL_SELECT + " WHERE Program_code = ? AND competence_code = ? AND version = ?", new Object[] { programCode, competenceCode, version } );
	}
