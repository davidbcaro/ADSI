...
/** 
 * This class represents the primary key of the competence table.
 */
public class CompetencePk implements Serializable
{
	 ...
	 * @param version
	 */
	public CompetencePk(final String competenceCode, final String programCode, final String version)
	{
		this.competenceCode = competenceCode;
		this.programCode = programCode;
		this.version = version;
	...
	public boolean equals(Object _other)
	{
		...
		if (!(_other instanceof CompetencePk)) {
			return false;
		}
		
		final CompetencePk _cast = (CompetencePk) _other;
	...
	public String toString()
	{
		...
		ret.append( "co.edu.sena.controler.dao.dto.CompetencePk: " );
