...
import co.edu.sena.model.dao.dao.LogAuditDao;
import co.edu.sena.model.dao.dto.LogAudit;
import co.edu.sena.model.dao.exceptions.LogAuditDaoException;
import co.edu.sena.model.dao.factory.LogAuditDaoFactory;
...
public class LogAuditDaoSample
{
	...
	public static void findWhereIdLogEquals(long idLog)
	{
		try {
			LogAuditDao _dao = getLogAuditDao();
			LogAudit _result[] = _dao.findWhereIdLogEquals(idLog);
			for (int i=0; i<_result.length; i++ ) {
				display( _result[i] );
			}
