...
calls to this DAO, otherwise a new Connection will be allocated for each operation.
	 ...
	 */
	protected final String SQL_SELECT = "SELECT document_Number, id_Document, first_Name, second_Name, first_Lastname, second_Lastname, photo FROM " + getTableName() + "";
	 ...
	 */
	protected final String SQL_INSERT = "INSERT INTO " + getTableName() + " ( document_Number, id_Document, first_Name, second_Name, first_Lastname, second_Lastname, photo ) VALUES ( ?, ?, ?, ?, ?, ?, ? )";

	/** 
	 * SQL UPDATE statement for this table
	 */
	protected final String SQL_UPDATE = "UPDATE " + getTableName() + " SET document_Number = ?, id_Document = ?, first_Name = ?, second_Name = ?, first_Lastname = ?, second_Lastname = ?, photo = ? WHERE id_Document = ? AND document_Number = ?";
	...
	{
		Client ret[] = findByDynamicSelect( SQL_SELECT + " WHERE id_Document = ? AND document_Number = ?", new Object[] { idDocument, documentNumber } );
