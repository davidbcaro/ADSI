...
calls to this DAO, otherwise a new Connection will be allocated for each operation.
	 ...
	 */
	protected final String SQL_SELECT = "SELECT initials_Working_Day, name, description, image, state FROM " + getTableName() + "";
	 ...
	 */
	protected final String SQL_INSERT = "INSERT INTO " + getTableName() + " ( initials_Working_Day, name, description, image, state ) VALUES ( ?, ?, ?, ?, ? )";

	/** 
	 * SQL UPDATE statement for this table
	 */
	protected final String SQL_UPDATE = "UPDATE " + getTableName() + " SET initials_Working_Day = ?, name = ?, description = ?, image = ?, state = ? WHERE initials_Working_Day = ?";

	/** 
	 * SQL DELETE statement for this table
	 */
	protected final String SQL_DELETE = "DELETE FROM " + getTableName() + " WHERE initials_Working_Day = ?";

	/** 
	 * Index of column initials_Working_Day
	 */
	protected static final int COLUMN_INITIALS_WORKING_DAY = 1;
	 ...
	 */
	protected static final int PK_COLUMN_INITIALS_WORKING_DAY = 1;
	...
	public void update(WorkingDayPk pk, WorkingDay dto) throws WorkingDayDaoException
	{
		...
		try {
			...
			stmt.setString( 6, pk.getInitialsWorkingDay() );
			int rows = stmt.executeUpdate();
			reset(dto);
			long t2 = System.currentTimeMillis();
			System.out.println( rows + " rows affected (" + (t2-t1) + " ms)" );
	...
	public void delete(WorkingDayPk pk) throws WorkingDayDaoException
	{
		...
		try {
			...
			stmt.setString( 1, pk.getInitialsWorkingDay() );
			int rows = stmt.executeUpdate();
			long t2 = System.currentTimeMillis();
			System.out.println( rows + " rows affected (" + (t2-t1) + " ms)" );
		}
	...
	{
		return findByPrimaryKey( pk.getInitialsWorkingDay() );
	}
	...
	{
		WorkingDay ret[] = findByDynamicSelect( SQL_SELECT + " WHERE initials_Working_Day = ?", new Object[] { initialsWorkingDay } );
	...
	{
		return findByDynamicSelect( SQL_SELECT + " ORDER BY initials_Working_Day", null );
	}
