...
public class NumberGroupHasTrimesterPK implements Serializable {
    ...
    public String toString() {
        return "co.edu.sena.wariosoftjpa.model.jpa.entities.NumberGroupHasTrimesterPK[ numberGroup=" + numberGroup + ", nameTrimester=" + nameTrimester + ", initialsWorkingDay=" + initialsWorkingDay + ", trainingLevel=" + trainingLevel + " ]";
    }
