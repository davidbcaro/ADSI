...
public class AvailabilityPK implements Serializable {
    ...
    public String toString() {
        return "co.edu.sena.wariosoftjpa.model.jpa.entities.AvailabilityPK[ startTime=" + startTime + ", initialsWorkingDay=" + initialsWorkingDay + ", idDocument=" + idDocument + ", documentNumber=" + documentNumber + ", nameDay=" + nameDay + " ]";
    }
