...
public class TeacherPK implements Serializable {
    ...
    public TeacherPK(String idDocument, String documentNumber) {
    ...
    public String toString() {
        return "co.edu.sena.wariosoftjpa.model.jpa.entities.TeacherPK[ idDocument=" + idDocument + ", documentNumber=" + documentNumber + " ]";
    }
