...
public class TrimesterPK implements Serializable {
    ...
    public String toString() {
        return "co.edu.sena.wariosoftjpa.model.jpa.entities.TrimesterPK[ nameTrimester=" + nameTrimester + ", trainingLevel=" + trainingLevel + ", initialsWorkingDay=" + initialsWorkingDay + " ]";
    }
