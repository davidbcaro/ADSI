...
public class LearningOutcomePK implements Serializable {
    ...
    public String toString() {
        return "co.edu.sena.wariosoftjpa.model.jpa.entities.LearningOutcomePK[ learningOutcomeCode=" + learningOutcomeCode + ", competitionCode=" + competitionCode + ", programCode=" + programCode + ", version=" + version + " ]";
    }
