...
@NamedQueries({
    ...
    , @NamedQuery(name = "Teacher.findByIdDocument", query = "SELECT t FROM Teacher t WHERE t.teacherPK.idDocument = :idDocument")
    , @NamedQuery(name = "Teacher.findByDocumentNumber", query = "SELECT t FROM Teacher t WHERE t.teacherPK.documentNumber = :documentNumber")})
public class Teacher implements Serializable {
    ...
    public String toString() {
        return "co.edu.sena.htmlwariosoft.model.entities.Teacher[ teacherPK=" + teacherPK + " ]";
    }
