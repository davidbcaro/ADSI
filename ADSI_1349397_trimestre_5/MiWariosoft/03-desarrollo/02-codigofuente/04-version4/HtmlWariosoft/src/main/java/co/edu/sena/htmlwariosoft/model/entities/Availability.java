...
@NamedQueries({
    ...
    , @NamedQuery(name = "Availability.findByInitialsWorkingDay", query = "SELECT a FROM Availability a WHERE a.availabilityPK.initialsWorkingDay = :initialsWorkingDay")
...
public class Availability implements Serializable {
    ...
    public String toString() {
        return "co.edu.sena.htmlwariosoft.model.entities.Availability[ availabilityPK=" + availabilityPK + " ]";
    }
