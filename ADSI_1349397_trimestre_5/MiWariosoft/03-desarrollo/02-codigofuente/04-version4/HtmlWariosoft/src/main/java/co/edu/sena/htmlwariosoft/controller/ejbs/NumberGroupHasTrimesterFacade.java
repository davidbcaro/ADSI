 ...
 */
@Stateless
public class NumberGroupHasTrimesterFacade extends AbstractFacade<NumberGroupHasTrimester> {
    ...
    public NumberGroupHasTrimesterFacade() {
        super(NumberGroupHasTrimester.class);
    }
