...
import co.edu.sena.htmlwariosoft.model.entities.Specialty;
...
import co.edu.sena.htmlwariosoft.controller.ejbs.SpecialtyFacade;
...
public class SpecialtyController implements Serializable {
    ...
    @EJB
    private co.edu.sena.htmlwariosoft.controller.ejbs.SpecialtyFacade ejbFacade;
    ...
    public Specialty getSpecialty(java.lang.String id) {
    ...
    public static class SpecialtyControllerConverter implements Converter {
        ...
        public String getAsString(FacesContext facesContext, UIComponent component, Object object) {
            ...
            if (object instanceof Specialty) {
                ...
                return getStringKey(o.getNameSpecialty());
            } else {
