...
public class TrainingLevelDaoImpl extends AbstractDAO implements TrainingLevelDao
{
	/** 
...
calls to this DAO, otherwise a new Connection will be allocated for each operation.
	 ...
	 */
	protected final String SQL_SELECT = "SELECT training_Level, State FROM " + getTableName() + "";
	 ...
	 */
	protected final String SQL_INSERT = "INSERT INTO " + getTableName() + " ( training_Level, State ) VALUES ( ?, ? )";

	/** 
	 * SQL UPDATE statement for this table
	 */
	protected final String SQL_UPDATE = "UPDATE " + getTableName() + " SET training_Level = ?, State = ? WHERE training_Level = ?";

	/** 
	 * SQL DELETE statement for this table
	 */
	protected final String SQL_DELETE = "DELETE FROM " + getTableName() + " WHERE training_Level = ?";

	/** 
	 * Index of column training_Level
	 */
	protected static final int COLUMN_TRAINING_LEVEL = 1;
	 ...
	 */
	protected static final int PK_COLUMN_TRAINING_LEVEL = 1;
	...
	public TrainingLevelPk insert(TrainingLevel dto) throws TrainingLevelDaoException
	{
		...
		try {
			...
			_e.printStackTrace();
			throw new TrainingLevelDaoException( "Exception: " + _e.getMessage(), _e );
		}
		finally {
	...
	public void delete(TrainingLevelPk pk) throws TrainingLevelDaoException
	{
		...
		try {
			...
			stmt.setString( 1, pk.getTrainingLevel() );
			int rows = stmt.executeUpdate();
			long t2 = System.currentTimeMillis();
			System.out.println( rows + " rows affected (" + (t2-t1) + " ms)" );
		}
	...
	{
		return findByPrimaryKey( pk.getTrainingLevel() );
	}
	...
	{
		TrainingLevel ret[] = findByDynamicSelect( SQL_SELECT + " WHERE training_Level = ?", new Object[] { trainingLevel } );
	...
	{
		return findByDynamicSelect( SQL_SELECT + " ORDER BY training_Level", null );
	}
	...
	/**
	 * Method 'TrainingLevelDaoImpl'
	 * 
	 */
	public TrainingLevelDaoImpl()
	{
	}
	 ...
	 * @param userConn
	 */
	public TrainingLevelDaoImpl(final java.sql.Connection userConn)
	{
	...
	{
		return "eon.training_level";
	}

	/** 
	 * Fetches a single row from the result set
	 */
	protected TrainingLevel fetchSingleResult(ResultSet rs) throws SQLException
	{
		if (rs.next()) {
			TrainingLevel dto = new TrainingLevel();
			populateDto( dto, rs);
			return dto;
		} else {
			return null;
	 ...
	 */
	protected TrainingLevel[] fetchMultiResults(ResultSet rs) throws SQLException
	{
		...
		TrainingLevel ret[] = new TrainingLevel[ resultList.size() ];
	 ...
	 */
	protected void populateDto(TrainingLevel dto, ResultSet rs) throws SQLException
	{
	 ...
	 */
	protected void reset(TrainingLevel dto)
	{
	}
