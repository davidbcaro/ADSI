...
{
	/** 
	 * This attribute maps to the column id_Log in the auditory_log table.
	 */
	protected long idLog;

	/** 
	 * This attribute maps to the column Level in the auditory_log table.
	 */
	protected String level;

	/** 
	 * This attribute maps to the column log_Name in the auditory_log table.
	 */
	protected String logName;

	/** 
	 * This attribute maps to the column Message in the auditory_log table.
	 */
	protected String message;

	/** 
	 * This attribute maps to the column Date in the auditory_log table.
	 */
	protected Date date;

	/** 
	 * This attribute maps to the column User in the auditory_log table.
	 */
	...
	public boolean equals(Object _other)
	{
		...
		if (!(_other instanceof AuditoryLog)) {
			return false;
		}
		
		final AuditoryLog _cast = (AuditoryLog) _other;
	 ...
	 * Method 'createPk'
	 * 
	 * @return AuditoryLogPk
	 */
	public AuditoryLogPk createPk()
	{
		return new AuditoryLogPk(idLog);
	}
	...
	public String toString()
	{
		...
		ret.append( "co.edu.sena.dto.AuditoryLog: " );
