...
calls to this DAO, otherwise a new Connection will be allocated for each operation.
	 ...
	 */
	protected final String SQL_SELECT = "SELECT idCurrent_Quarter, start_Date, end_Date FROM " + getTableName() + "";
	 ...
	 */
	protected final String SQL_INSERT = "INSERT INTO " + getTableName() + " ( idCurrent_Quarter, start_Date, end_Date ) VALUES ( ?, ?, ? )";

	/** 
	 * SQL UPDATE statement for this table
	 */
	protected final String SQL_UPDATE = "UPDATE " + getTableName() + " SET idCurrent_Quarter = ?, start_Date = ?, end_Date = ? WHERE idCurrent_Quarter = ?";

	/** 
	 * SQL DELETE statement for this table
	 */
	protected final String SQL_DELETE = "DELETE FROM " + getTableName() + " WHERE idCurrent_Quarter = ?";

	/** 
	 * Index of column idCurrent_Quarter
	 */
	protected static final int COLUMN_IDCURRENT_QUARTER = 1;
	...
	{
		CurrentQuarter ret[] = findByDynamicSelect( SQL_SELECT + " WHERE idCurrent_Quarter = ?", new Object[] { idcurrentQuarter } );
	...
	{
		return findByDynamicSelect( SQL_SELECT + " ORDER BY idCurrent_Quarter", null );
	}
