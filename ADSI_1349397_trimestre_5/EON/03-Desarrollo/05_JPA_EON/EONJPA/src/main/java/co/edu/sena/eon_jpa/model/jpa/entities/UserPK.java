...
public class UserPK implements Serializable {
    ...
    public UserPK(String documentNumber, String idDocument) {
    ...
    public String toString() {
        return "co.edu.sena.eon_jpa.model.jpa.entities.UserPK[ documentNumber=" + documentNumber + ", idDocument=" + idDocument + " ]";
    }
