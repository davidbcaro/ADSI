...
public class ActivityPkDTO {
    ...
    public int hashCode() {
        int hash = 3;
        hash = 79 * hash + this.id_activity;
        hash = 79 * hash + Objects.hashCode(this.phase_name_phase);
        hash = 79 * hash + this.phase_project_code;
        return hash;
    }
    ...
    public boolean equals(Object obj) {
        ...
        final ActivityPkDTO other = (ActivityPkDTO) obj;
    ...
    public String toString() {
        return "ActivityPkDTO{" + "id_activity=" + id_activity + ", phase_name_phase=" + phase_name_phase + ", phase_project_code=" + phase_project_code + '}';
    }
