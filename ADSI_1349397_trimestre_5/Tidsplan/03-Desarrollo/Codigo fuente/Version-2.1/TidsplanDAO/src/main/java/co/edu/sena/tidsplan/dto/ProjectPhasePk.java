...
/** 
 * This class represents the primary key of the project_phase table.
 */
public class ProjectPhasePk implements Serializable
{
	 ...
	 * @param projectCode
	 */
	public ProjectPhasePk(final String namePhase, final String projectCode)
	{
		this.namePhase = namePhase;
		this.projectCode = projectCode;
	}
	...
	public boolean equals(Object _other)
	{
		...
		if (!(_other instanceof ProjectPhasePk)) {
			return false;
		}
		
		final ProjectPhasePk _cast = (ProjectPhasePk) _other;
	...
	public String toString()
	{
		...
		ret.append( "co.edu.sena.tidsplan.dto.ProjectPhasePk: " );
