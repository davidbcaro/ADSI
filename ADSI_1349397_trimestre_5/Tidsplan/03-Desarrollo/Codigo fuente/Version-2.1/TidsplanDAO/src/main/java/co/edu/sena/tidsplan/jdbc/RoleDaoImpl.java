...
calls to this DAO, otherwise a new Connection will be allocated for each operation.
	 ...
	 */
	protected final String SQL_SELECT = "SELECT id_rol, description, status FROM " + getTableName() + "";
	 ...
	 */
	protected final String SQL_INSERT = "INSERT INTO " + getTableName() + " ( id_rol, description, status ) VALUES ( ?, ?, ? )";

	/** 
	 * SQL UPDATE statement for this table
	 */
	protected final String SQL_UPDATE = "UPDATE " + getTableName() + " SET id_rol = ?, description = ?, status = ? WHERE id_rol = ?";
	...
	/** 
	 * Returns all rows from the role table that match the criteria 'id_rol = :idRol'.
	 */
	public Role findByPrimaryKey(String idRol) throws RoleDaoException
	{
		Role ret[] = findByDynamicSelect( SQL_SELECT + " WHERE id_rol = ?", new Object[] { idRol } );
	 ...
	 * Returns all rows from the role table that match the criteria 'id_rol = :idRol'.
	 */
	public Role[] findWhereIdRolEquals(String idRol) throws RoleDaoException
	{
