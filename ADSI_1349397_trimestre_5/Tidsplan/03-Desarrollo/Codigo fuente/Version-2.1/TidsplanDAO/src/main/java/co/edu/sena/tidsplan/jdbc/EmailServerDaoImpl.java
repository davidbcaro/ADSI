...
calls to this DAO, otherwise a new Connection will be allocated for each operation.
	 ...
	 */
	protected final String SQL_SELECT = "SELECT mail, password, smtp_host, smtp_port, smtp_start_tls_enable, smtp_auth, recovery_case, recovery_message FROM " + getTableName() + "";
	 ...
	 */
	protected final String SQL_INSERT = "INSERT INTO " + getTableName() + " ( mail, password, smtp_host, smtp_port, smtp_start_tls_enable, smtp_auth, recovery_case, recovery_message ) VALUES ( ?, ?, ?, ?, ?, ?, ?, ? )";

	/** 
	 * SQL UPDATE statement for this table
	 */
	protected final String SQL_UPDATE = "UPDATE " + getTableName() + " SET mail = ?, password = ?, smtp_host = ?, smtp_port = ?, smtp_start_tls_enable = ?, smtp_auth = ?, recovery_case = ?, recovery_message = ? WHERE mail = ?";
	...
	{
		EmailServer ret[] = findByDynamicSelect( SQL_SELECT + " WHERE mail = ?", new Object[] { mail } );
