...
public class UserPK implements Serializable {
    ...
    public UserPK(String document, String documentNumber) {
    ...
    public String toString() {
        return "co.edu.sena.tidsplanjpa.model.jpa.entities.UserPK[ document=" + document + ", documentNumber=" + documentNumber + " ]";
    }
