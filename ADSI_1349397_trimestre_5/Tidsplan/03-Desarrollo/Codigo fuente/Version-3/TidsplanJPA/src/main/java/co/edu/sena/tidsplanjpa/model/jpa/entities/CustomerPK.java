...
public class CustomerPK implements Serializable {
    ...
    public CustomerPK(String document, String documentNumber) {
    ...
    public String toString() {
        return "co.edu.sena.tidsplanjpa.model.jpa.entities.CustomerPK[ document=" + document + ", documentNumber=" + documentNumber + " ]";
    }
